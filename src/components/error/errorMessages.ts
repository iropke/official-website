...
const es: Record<ErrorKind, ErrorCopy> = {
  '404': {
    ...
    witty: 'Entiendo la sensación. Perderse pasa.',
    description:
  ...
  '500': {
    ...
    witty: 'Parece que algo detrás del telón está teniendo un momento.',
  ...
  '503': {
    ...
    witty: 'Estamos brevemente fuera de servicio. Incluso los sistemas necesitan respirar.',
    description:
  ...
  '403': {
    ...
    witty: 'Esta puerta parece requerir una llave diferente.',
...
const ru: Record<ErrorKind, ErrorCopy> = {
  '404': {
    ...
    witty: 'Знакомое чувство. Заблудиться — это нормально.',
    description:
  ...
  '500': {
    ...
    witty: 'Похоже, что-то за кулисами переживает непростой момент.',
  ...
  '503': {
    ...
    witty: 'Мы ненадолго недоступны. Даже системам нужна передышка.',
  ...
  '403': {
    ...
    witty: 'Похоже, эта дверь требует другого ключа.',
...
const de: Record<ErrorKind, ErrorCopy> = {
  '404': {
    ...
    witty: 'Das Gefühl kenne ich. Sich zu verirren passiert.',
    description:
  ...
  '500': {
    ...
    witty: 'Hinter den Kulissen scheint gerade etwas einen Moment zu brauchen.',
    description:
  ...
  '503': {
    ...
    witty: 'Wir sind kurz nicht erreichbar. Auch Systeme brauchen mal eine Pause.',
    description:
  ...
  '403': {
    ...
    witty: 'Diese Tür scheint einen anderen Schlüssel zu benötigen.',
...
const fr: Record<ErrorKind, ErrorCopy> = {
  '404': {
    ...
    witty: 'Je comprends ce sentiment. Se perdre, ça arrive.',
    description:
  ...
  '500': {
    ...
    witty: 'On dirait que quelque chose en coulisses traverse un mauvais moment.',
    description:
  ...
  '503': {
    ...
    witty: 'Nous sommes brièvement indisponibles. Même les systèmes ont besoin d’une pause.',
    description:
  ...
  '403': {
    title: 'Accès refusé',
    witty: 'Cette porte semble nécessiter une autre clé.',
    description:
...
const ar: Record<ErrorKind, ErrorCopy> = {
  '404': {
    ...
    witty: 'أفهم هذا الشعور. الضياع يحدث للجميع.',
  ...
  '500': {
    title: 'خطأ في الخادم',
    witty: 'يبدو أن شيئًا خلف الكواليس يمر بلحظة عصيبة.',
  ...
  '503': {
    ...
    witty: 'نحن متوقفون لبرهة. حتى الأنظمة تحتاج إلى نَفَس.',
  ...
  '403': {
    title: 'تم رفض الوصول',
    witty: 'يبدو أن هذا الباب يحتاج إلى مفتاح آخر.',
