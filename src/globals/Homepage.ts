          ...
          fields: [
            {
              ...
              fields: [
                ...
                { name: 'backgroundImage', type: 'upload', label: '배경 이미지', relationTo: 'media', admin: { condition: (data, siblingData) => siblingData?.backgroundType === 'image' } },
              ],
            },
          ],
        },
          ...
          fields: [
            { name: 'gridSectionTitle', type: 'text', label: '섹션 제목', localized: true, defaultValue: 'IROPKE OS™' },
            {
              ...
              fields: [
                ...
                { name: 'icon', type: 'upload', label: '아이콘 (SVG)', relationTo: 'media' },
              ],
            },
          ],
        },
